...
parser.add_argument('--dataset_path',default = '../dataset/medical_image/processed_data',help='fixed trainset root path')
parser.add_argument('--test_data_path',default = '/ssd/lzq/dataset/LiTS/test',help='Testset path')
parser.add_argument('--exp_name',default='ResUNet',help='save path of trained model')
...
parser.add_argument('--crop_size', type=list, default=[256, 256, 256])
